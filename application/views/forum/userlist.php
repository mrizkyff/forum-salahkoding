	...
	<body style="margin-top: 50px;">
		...
		<br>
		 ...
		 <!-- notifikasi hapus komentar -->
            ...
            <div id="notification" class="alert alert-success text-center" role="alert" style="position: absolute;top: 55px;width: 100%"><b> <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><?php echo $this->session->flashdata('deleteUser'); ?> </b><br></div>
            <?php } ?>
		...
		<!-- awal tabel konten -->
			<table class="table table-striped text-light" style="width: 90%" align="center">
				...
				<tr>
					...
					<td class="text-center"><img src="<?php echo base_url() ?>asset/img/user/<?php echo $users['foto'] ?>" alt="<?php $users['nim'] ?>" width="75px" height="100px"></td>
					<td class="text-center"><?php echo $users['username'] ?></td>
					<td class="text-center"><?php echo $users['nim'] ?></td>
					<td class="text-center"><?php echo $users['email'] ?></td>
					<td class="text-center"><?php echo $users['jenis_kelamin'] ?></td>
					<td class="text-center"><?php echo $users['tanggal'] ?></td>
					<td class="text-center"><?php echo $users['level'] ?></td>
					<td class="text-center"><a href="<?php echo base_url(). 'home/delUser' ?>?id=<?php echo $users['id'] ?>&userid=<?php echo $id ?>" class="btn btn-danger">HAPUS</a></td>
				</tr>
				<?php endforeach; ?>
			</table>
		<!-- akhir tabel -->
