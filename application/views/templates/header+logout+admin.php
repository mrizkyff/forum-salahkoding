        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNavDropdown">
          ...
          <ul class="navbar-nav">
            <li class="nav-item active">
              <a class="nav-link" href="<?php echo base_url()?>?pesan=logout">Home</a>
            </li>
            <li class="nav-item active">
            ...
            <li class="nav-item dropdown active">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  <a href="<?php echo base_url(). 'home/userList' ?>?userid=<?php echo $id ?>" class="nav-link dropdown-item text-dark">List User</a>
                  <a href="<?php echo base_url(). 'home/fileList' ?>?userid=<?php echo $id ?>" class="nav-link dropdown-item text-dark">List File</a>
                  <a href="<?php echo base_url(). 'home/addAdmin' ?>?userid=<?php echo $id ?>" class="nav-link dropdown-item text-dark">Tambah Admin</a>
              </div>
            </li> 
            <li class="nav-item dropdown active">
              <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
